...
An example `ros2_control` URDF config with this hardware interface can be found in [our main repo](https://github.com/OpenFieldAutomation-OFA/ros-weed-control/blob/main/ofa_moveit_config/ros2_control/ofa_robot.ros2_control.urdf.xacro).
...
- `direction`: OPTIONAL. Use `-1` to invert a motor whose positive encoder/command direction is opposite the robot joint direction. Defaults to `1`.
